...
def upload_pdf():
    ...
    try:
        ...
        # Gerar URLs de download e visualização
        download_url = url_for('pdf_storage.download_pdf', file_id=file_id, _external=True)
        view_url = url_for('pdf_storage.view_pdf', file_id=file_id, _external=True)
...
@pdf_storage_bp.route('/view/<file_id>')
def view_pdf(file_id):
    ...
    try:
        ...
        # Incrementar contador de downloads/visualizações
        pdf_file.increment_download_count()
